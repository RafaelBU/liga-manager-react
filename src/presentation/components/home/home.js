    ...
    return (
        <div style={{ backgroundColor: "#f5f5f5", height: "100vh" }}>
            ...
            <div className="container-fluid" style={{ marginTop: 100 }}>
                {showModalHelp ? <ModalHelp titleHelp="Liga manager"
                    ...
                    textHelp2="Desde aquí puedes acceder a las distintas secciones del simulador: Mercado de fichajes y Alineación." onClose={() => setShowModalHelp(false)} /> : ""}
                <Typography
                    variant="h4"
                    component="h4"
                    align="center"
                ...
                >
                    Liga Manager <HelpOutlineIcon style={{ cursor: "pointer" }} onClick={() => setShowModalHelp(true)} />
                </Typography>
